...
import java.util.List;
    ...
    public final class GraphView extends JPanel {
        ...
        private final static int numberYDivisions = 6;
        private final static Color lineColour = new Color(44, 102, 230, 180);
        private final static Color pointColour = new Color(100, 100, 100, 180);
        private final static Color gridColour = new Color(200, 200, 200, 200);
